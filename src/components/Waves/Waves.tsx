...
export default function Waves({}: Props) {
  return (
    ...
    >
      ...
      <motion.path
        variants={item}
        d="M1440 372.438L1410 305.986C1380 240.157 1320 106.32 1260 65.3902C1200 23.8383 1140 73.6383 1080 73.6383C1020 73.6383 960 23.8383 900 7.18641C840 -8.84297 780 6.71954 720 48.7383C660 90.757 600 156.12 540 173.238C480 190.357 420 156.12 360 164.99C300 173.238 240 223.038 180 256.186C120 289.957 60 305.52 30 314.39L0 322.638V422.238H30C60 422.238 120 422.238 180 422.238C240 422.238 300 422.238 360 422.238C420 422.238 480 422.238 540 422.238C600 422.238 660 422.238 720 422.238C780 422.238 840 422.238 900 422.238C960 422.238 1020 422.238 1080 422.238C1140 422.238 1200 422.238 1260 422.238C1320 422.238 1380 422.238 1410 422.238H1440V372.438Z"
